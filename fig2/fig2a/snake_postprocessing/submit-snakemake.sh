...
snakemake \
    --snakefile /project2/nobrega/grace/expression/scripts/snake_postprocess/Snakefile_M \
    -kp \
    -j 40 \
    --rerun-incomplete \
    --cluster-config /project2/nobrega/grace/expression/scripts/snake_postprocess/cluster.json \
    -c "sbatch \
        --mem={cluster.mem} \
        --nodes={cluster.n} \
