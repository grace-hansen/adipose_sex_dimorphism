...
snakemake \
    --snakefile /project2/nobrega/grace/expression/scripts/snake_TWAS/Snakefile_M \
    -kp \
    -j 500 \
    --rerun-incomplete \
    --cluster-config /project2/nobrega/grace/expression/scripts/snake_TWAS/cluster.json \
    -c "sbatch \
        --mem={cluster.mem} \
        --nodes={cluster.n} \
